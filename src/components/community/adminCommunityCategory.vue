			...
			<div class="container">	
				<div class="row">
					...
					<div class="category_button_top">
						...
						<Input v-model="value" placeholder="Enter Catgeroy..." style="width: 220px" />
						<button class="_btn _action_btn view_btn1 category_button" type="button">Add Category</button>
